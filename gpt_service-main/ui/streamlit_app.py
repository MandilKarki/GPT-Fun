...
def main():
    st.set_page_config(  # Alternate names: setup_page, page, layout
        ...
        page_title="GPT-J LM Demo",  # String or None. Strings get appended with "• Streamlit".
        page_icon=None,  # String, anything supported by st.image, or None.
    )
    st.title("GPT-J Language Model Demo")
...
A:""",
    ...
    with st.beta_expander("Options..."):
        ...
        temp = st.slider(
            "Temperature (higher - more random, lower - more repetitive). For the code generation or sentence classification promps it's recommended to use a lower value, like 0.35",
            0.0,
            1.5,
